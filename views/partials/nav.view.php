        ...
        <div class="container">
          <nav class="nav">
            ...
            <?php if (!isset($_SESSION['user_id'])) : ?>
              ...
              <a class="nav-link" href="/Drugi_dio_b/register/">Registracija</a>
            <?php endif ;?>
            <?php if (isset($_SESSION['user_id'])) : ?>
              <a class="nav-link" href="/Drugi_dio_b/todos/create/">Dodaj novu listu</a>
              <a class="nav-link" href="/Drugi_dio_b/todos/">Moje liste</a>
              <a class="nav-link ml-md-auto" href="#">Dobrodosli <?=$_SESSION['ime'] ?> !!!</a>
              <a class="nav-link" href="/Drugi_dio_b/logout/">Odjava</a>
            <?php endif ; ?>
          </nav>
        </div>
      </div>
